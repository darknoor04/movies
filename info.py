...
#---------------------------------------------------------------
#---------------------------------------------------------------
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1729311491 5016109398').split()]
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002287742443').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://NOOR04:darknoor04@cluster0.ef9a3.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002429677844')
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002429677844')) # 
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/Erro_support') #Support group link ( make sure bot is admin )
#---------------------------------------------------------------
#---------------------------------------------------------------
...
SHORTENER_API = environ.get("SHORTENER_API", " 04e8ee10b5f123456a640c8f33195abc")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", 'omegalinks.in')
SHORTENER_API2 = environ.get("SHORTENER_API2", " 04e8ee10b5f123456a640c8f33195abc")
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", 'omegalinks.in')
SHORTENER_API3 = environ.get("SHORTENER_API3", " 04e8ee10b5f123456a640c8f33195abc")
